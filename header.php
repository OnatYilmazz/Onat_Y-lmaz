								...
								<li>
									<div class="info-box">
										<div class="info-box-content">
											<p class="info-box-title"><?php echo $ayarcek['baslik']?></p>
											<p class="info-box-subtitle"><?php echo $ayarcek['aciklama']?></p>
										</div>
									</div>
								</li>
								<li>
							...
							<div class="site-nav-inner pull-left">
								...
								<div class="collapse navbar-collapse navbar-responsive-collapse">
									<ul class="nav navbar-nav">
										...
										<li class="dropdown">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown">EĞİTİM<i
													class="fa fa-angle-down"></i></a>
											<ul class="dropdown-menu" role="menu">
												<li><a href="hakkimizda.php">Hakkımızda</a></li>
												<li><a href="team.html">Eğitmenlerimiz</a></li>
										...
										<li class="dropdown">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown">EĞİTİMLER<i
													class="fa fa-angle-down"></i></a>
											<ul class="dropdown-menu" role="menu">
												<li><a href="projects.php">Tüm Eğitimler</a></li>
												<li><a href="projects-single.php">Tekli Eğitimler</a></li>
											</ul>
										</li>
										...
										<li class="dropdown">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown">HİZMETLER<i
													class="fa fa-angle-down"></i></a>
											<ul class="dropdown-menu" role="menu">
												<li><a href="services.php">Tüm Hizmetler</a></li>
												<li><a href="service-single.php">Tekli Hizmetler</a></li>
											</ul>
										</li>
